<?php
    ...
    $this->breadcrumbs = array('Profile' => array('/profile'),'Student',);
                ...
                <div id="inside">
                    <?php
                        ...
                        if (!empty($coverletter->file_path))
                            echo '<strong>' . CHtml::link(CHtml::encode('Cover Letter'), $coverletter->file_path, array('target' => '_blank', 'style' => 'float:left')) . '</strong>';
                        else
                        ...
                        if (isset($resume->resume))
                            echo '<strong>' . CHtml::link(CHtml::encode('Resume'), $resume->resume, array('target' => '_blank', 'style' => 'float:left')) . '</strong>';
                        else
                            echo 'No resume yet.';
                    ?> 
                </div>
...
?> 
                    ...
                    <div id="menutools" class="invisible">
