...
<div id="fullcontent" style="width:1200px;">
    ...
    <?php echo $form->textField($job, 'id', array('style' => 'display: none;')); ?><br>	
                                <lab2>TITLE:</lab2><?php echo $form->textField($job, 'title');?>                                
                                <br>	
...
date("D M d, Y "); ?> </div>
            ...
            <div class="one" id="div1" style="margin-bottom: 15px;
                ...
                <span class="notificationtitle" >Video Interviews </span> <span class="notificationtitle" style="float: right!important"><?php if ($countvideo != 0) {
    echo $countvideo;
} ?></span>
            </div>
...
?>
            ...
            <div class="two" id="div2"  style="margin-bottom: 15px;
                ...
                <span class="notificationtitle" >Applicants </span><span class="notificationtitle" style="float: right!important"><?php if ($countapplicants != 0) {
    echo $countapplicants;
} ?></span>
            </div>
...
<?php $count = 0; ?>
                    <?php foreach ($notification as $n) { ?>
                        ...
                        <?php if ($n->been_read == 0 & $n->importancy == 6) { ?>
                            <div style="background-color:#dff0d8;border-radius: 5px;padding:10px;">
...
?>
            ...
            <div class="three" id="div3"  style="margin-bottom: 15px;
                ...
                <span class="notificationtitle" >Messages</span><span class="notificationtitle" style="float: right!important"><?php if ($countmessages != 0) {
    echo $countmessages;
} ?></span>
            </div>
            <div class="child-div3" >
                <span class="subnotification">
                    ...
                    <?php foreach ($notification as $n) { ?>
                        ...
                        <?php if ($n->been_read == 0 & $n->importancy == 3 & $count < 6) { ?>
                            <div style="background-color:#dff0d8;border-radius: 5px;padding:10px;">
                                <p style="color:#468847"><a href="<?php echo $n->link . "?notificationRead=" . $n->id; ?>"><?php echo $n->message; ?></a>
                                <form style="float:right; margin:5px 5px 5px 5px; "action="/JobFair/index.php/Home/deleteNotification" >
                                    <input type="hidden" name="id" value="<?php echo $n->id ?>">
